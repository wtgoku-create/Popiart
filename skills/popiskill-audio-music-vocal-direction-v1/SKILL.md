---
name: popiskill-audio-music-vocal-direction-v1
description: Create structured vocal specifications for AI music generation. Use this when the user wants detailed direction for vocal style, register, emotion, phrasing, or artist-influence references.
allowed-tools: Read, Write, Edit, WebSearch
id: SK-MAC-007
---
# PopiArt Vocal Direction
