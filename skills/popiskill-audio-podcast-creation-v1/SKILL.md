---
name: popiskill-audio-podcast-creation-v1
description: Create AI-powered podcasts with text-to-speech, music, and audio editing. Use this when the user wants full podcast episodes, multi-voice dialogue, narrated audio newsletters, or podcast-style long-form audio content.
allowed-tools: Bash(infsh *)
---
# PopiArt Podcast Creation
