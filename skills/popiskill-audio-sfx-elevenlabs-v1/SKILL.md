---
name: popiskill-audio-sfx-elevenlabs-v1
description: Generate sound effects from text through ElevenLabs. Use this when the user wants ambient sounds, UI effects, cinematic impacts, or other non-speech audio assets from prompts.
license: MIT
compatibility: Requires internet access and an ElevenLabs API key (ELEVENLABS_API_KEY).
metadata: {"openclaw": {"requires": {"env": ["ELEVENLABS_API_KEY"]}, "primaryEnv": "ELEVENLABS_API_KEY"}}
---
# PopiArt ElevenLabs Sound Effects
