---
name: popiskill-video-text2video-studio-v1
description: Generate videos from prompts through a broad multi-model video stack. Use this when the user wants a general PopiArt video generation entry point for concept clips, social content, product demos, or quick motion ideation.
allowed-tools: Bash(infsh *)
---
# PopiArt Video Studio Basic
