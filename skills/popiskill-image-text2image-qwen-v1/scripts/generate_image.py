...
Usage:
    uv run generate_image.py --prompt "your image description" --filename "output.png" [--model popiskill-image-text2image-qwen-v1-max|popiskill-image-text2image-qwen-v1-turbo] [--size 1664*928|1024*1024|720*1280|1280*720] [--api-key KEY]
"""
...
def main():
    ...
    parser.add_argument(
        "--model", "-m",
        choices=["popiskill-image-text2image-qwen-v1-max", "popiskill-image-text2image-qwen-v1-turbo", "popiskill-image-text2image-qwen-v1-plus-2026-01-09"],
        default="popiskill-image-text2image-qwen-v1-max",
        help="Model to use: popiskill-image-text2image-qwen-v1-max (default) or popiskill-image-text2image-qwen-v1-turbo"
    )
    parser.add_argument(
        "--size", "-s",
