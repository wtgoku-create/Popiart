---
name: popiskill-audio-tool-flstudio-v1
description: Use FL Studio scripting for MIDI control, piano roll automation, Edison editing, and FLP manipulation. Trigger this when the user needs programmatic FL Studio workflows or controller scripting support.
---
# PopiArt FL Studio Tooling
