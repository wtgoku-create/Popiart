...
使用 [scripts/ws\_listener.py](../../../../../skills/popiskill-audio-tool-videodb-v1/scripts/ws_listener.py) 连接并将事件转储到 `${VIDEODB_EVENTS_DIR:-$HOME/.local/state/videodb}/videodb_events.jsonl`。
