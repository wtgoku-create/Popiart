---
name: popiskill-audio-tool-videodb-v1
description: Use VideoDB for media understanding, indexing, streaming, transcription, and timeline actions across video and audio. Trigger this when the user needs searchable media context or timeline-aware media operations.
origin: ECC
allowed-tools: Read Grep Glob Bash(python:*)
argument-hint: "[task description]"
---
# PopiArt VideoDB Media Tool
...
此技能的参考材料在 `skills/popiskill-audio-tool-videodb-v1/reference/` 下本地提供。
