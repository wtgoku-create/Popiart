---
name: popiskill-video-avatar-heygen-guide-v1
description: Use this reference-oriented HeyGen guide when the task is to understand best practices, API patterns, workflow guidance, or integration advice for HeyGen avatar videos.
metadata:
