---
name: popiskill-audio-music-evolink-v1
description: Generate music through the Evolink stack with Suno-backed models. Use this when the user wants prompt-based song generation, instrumental tracks, lyric-driven music, or provider-specific music creation flows.
version: 2.0.0
user-invocable: true
metadata:
  openclaw:
