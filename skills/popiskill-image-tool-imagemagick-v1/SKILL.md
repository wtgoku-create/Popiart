---
name: popiskill-image-tool-imagemagick-v1
description: Use ImageMagick for deterministic image tooling. Trigger this when the user needs resize, crop, compose, annotate, format conversion, or other utility-grade image operations.
---
# PopiArt ImageMagick Tooling
