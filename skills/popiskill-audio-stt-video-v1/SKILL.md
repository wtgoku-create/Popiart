---
name: popiskill-audio-stt-video-v1
description: Extract audio from videos or video URLs and transcribe it into text. Use this when the user needs speech-to-text for YouTube clips, recorded talks, podcasts, or other video sources.
metadata:
  {
    "openclaw": { "emoji": "🎬" },
    "version": "1.0.0",
...
```bash
# 进入脚本目录
cd ~/.openclaw/workspace/skills/popiskill-audio-stt-video-v1/scripts
