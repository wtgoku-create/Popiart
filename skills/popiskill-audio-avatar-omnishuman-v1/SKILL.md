---
name: popiskill-audio-avatar-omnishuman-v1
description: Create talking-head and avatar videos from audio-driven inputs through OmniHuman, Fabric, and PixVerse. Use this when the user wants lipsync output, digital presenters, or speech-led avatar motion from audio assets.
allowed-tools: Bash(infsh *)
---
# PopiArt OmniHuman Avatar Audio Drive
