---
name: popiskill-image-text2image-character-sheet-v1
description: Generate character design sheets and reference images. Use this when the user wants consistent characters, turnaround sheets, expression sheets, or visual reference packs.
allowed-tools: Bash(infsh *)
---
# PopiArt Character Sheet Basic
