---
name: popiskill-video-avatar-talking-head-v1
description: Create talking-head and AI avatar videos through PopiArt-compatible avatar models. Use this when the user wants lipsync clips, virtual presenters, digital humans, or audio-driven avatar output.
allowed-tools: Bash(infsh *)
---
# PopiArt Talking Head Avatar Basic
